<template>
  ...
  >
    ...
    >
      <h2 class="text-2xl mb-6">{{ form.id }} Yangi post qo'shish</h2>
      ...
      <button @click="closeModal" class="absolute right-6 top-6 cursor-pointer"><CloseSvg /></button>
...
const submit = () => {
  try {
    ...
    fetch('https://jsonplaceholder.typicode.com/posts', {
      ...
      .then((json) => postStore.setAddedPost(json))
  } catch (error) {
    console.log(error)
  } finally {
    modalStore.closeAddModal()
